...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "lavalink.kartadharta.xyz", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 443,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "kartadharta", 
            ...
            bot: {
                ...
                ownerIds: ["1380183114109947924"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/29RFuB6Ucj",    // 👈 Your support server link
